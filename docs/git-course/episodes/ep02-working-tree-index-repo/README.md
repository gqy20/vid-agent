...
- 音频：已按 EP01 流程重做，复用 EP01 BGM，分段 TTS 使用停顿标记、SRT、FFmpeg 人声响度规范化和固定低音量 BGM 混音；文件位于 `remotion/renders/git-course/ep02-working-tree-index-repo/renders/current/audio/`。
- 已完成分段：
