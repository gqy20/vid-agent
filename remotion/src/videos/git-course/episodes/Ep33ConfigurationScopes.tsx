...
const CommandScope=()=> <Term scene="command-scope" id="ep33-command-scope" result={<><SceneTitle style={{position:'absolute',top:112,left:180,right:180}}>Command 只影响本次调用</SceneTitle><FlowSteps revealAtSeconds={11} steps={[{label:'Local',tone:'neutral'},{label:'git -c',tone:'head'},{label:'Command',tone:'head'},{label:'Local',tone:'neutral'}]}/></>}/>;
