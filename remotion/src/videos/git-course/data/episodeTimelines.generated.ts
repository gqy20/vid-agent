...
export const EP08_SCENES = [
  ...
  {id: "takeaway", title: "总结", duration: seconds(20), captions: [{"from":0.25,"to":2.07,"text":"第一季最后收束成一张地图"},{"from":2.534,"to":6.959,"text":"reset 移动当前分支，并按模式影响 HEAD、Index 和 Working Tree"},{"from":7.509,"to":10.578,"text":"revert 向前创建反向提交，保留旧历史"},{"from":11.176,"to":13.704,"text":"restore 恢复选定路径，不移动 branch"},{"from":14.353,"to":18.485,"text":"真正需要判断的是对象、来源、目标和状态变化"}]},
] as const;
