...
const body = `
  ...
  <text x="1080" y="320" font-family="${FONT.sans}" font-size="180" font-weight="${K.WEIGHT.bold}" letter-spacing="-9" fill="${INK}">不是</text>
  <text x="1080" y="568" font-family="${FONT.sans}" font-size="180" font-weight="${K.WEIGHT.bold}" letter-spacing="-9" fill="${INK}">搬分支</text>
  <g transform="translate(150 770)">
    ...
    <text x="1390" y="185" text-anchor="middle" font-family="${FONT.mono}" font-size="34" font-weight="${K.WEIGHT.bold}" fill="${INK}">new commit</text>
  </g>`;
