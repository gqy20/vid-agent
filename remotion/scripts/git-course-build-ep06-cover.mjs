...
const body = `
  ...
  <text x="66" y="548" font-family="${FONT.mono}" font-size="300" font-weight="${K.WEIGHT.bold}" letter-spacing="-13" fill="${TOMATO}">merge</text>
  <text x="980" y="320" font-family="${FONT.sans}" font-size="180" font-weight="${K.WEIGHT.bold}" letter-spacing="-9" fill="${INK}">不是</text>
  <text x="980" y="568" font-family="${FONT.sans}" font-size="180" font-weight="${K.WEIGHT.bold}" letter-spacing="-9" fill="${INK}">复制粘贴</text>
  ${folder(90, 785, MUSTARD)}${folder(180, 820, TEAL)}
  <text x="760" y="950" text-anchor="middle" font-family="${FONT.sans}" font-size="160" font-weight="${K.WEIGHT.bold}" fill="${TOMATO}">≠</text>
  <g transform="translate(1040 720)">
    ...
    <text x="580" y="144" text-anchor="middle" font-family="${FONT.mono}" font-size="30" font-weight="${K.WEIGHT.bold}" fill="${INK}">M</text>
  </g>`;
