...
const commitObject = `
  <g transform="translate(1126 742)">
    ...
    <text x="30" y="39" font-family="${FONT.mono}" font-size="27" font-weight="${K.WEIGHT.bold}" fill="${INK}">commit object</text>
    <text x="42" y="116" font-family="${FONT.mono}" font-size="38" font-weight="${K.WEIGHT.bold}" fill="${TEAL}">tree</text>
    <path d="M176 104 H480" stroke="${TEAL}" stroke-width="10" stroke-linecap="round"/>
    <path d="M472 88 L508 104 L472 120 Z" fill="${TEAL}"/>
    <text x="42" y="194" font-family="${FONT.mono}" font-size="38" font-weight="${K.WEIGHT.bold}" fill="${TOMATO}">parent</text>
...
const body = `
  ...
  <text x="66" y="548" font-family="${FONT.mono}" font-size="285" font-weight="${K.WEIGHT.bold}" letter-spacing="-12" fill="${TOMATO}">commit</text>
  <text x="1060" y="320" font-family="${FONT.sans}" font-size="190" font-weight="${K.WEIGHT.bold}" letter-spacing="-9" fill="${INK}">不是</text>
  <text x="1060" y="568" font-family="${FONT.sans}" font-size="190" font-weight="${K.WEIGHT.bold}" letter-spacing="-9" fill="${INK}">保存按钮</text>
