...
const folder = `
  <g transform="translate(116 775)">
    ...
    <text x="224" y="144" text-anchor="middle" font-family="${FONT.sans}" font-size="55" font-weight="${K.WEIGHT.bold}" fill="${INK}">项目副本</text>
  </g>`;
...
const pointerModel = `
  <g transform="translate(1074 742)">
    ...
    <text x="157" y="75" text-anchor="middle" font-family="${FONT.mono}" font-size="32" font-weight="${K.WEIGHT.bold}" fill="${INK}">main</text>
    <rect x="458" y="34" width="170" height="58" rx="12" fill="${TOMATO}" stroke="${INK}" stroke-width="4"/>
    <text x="543" y="75" text-anchor="middle" font-family="${FONT.mono}" font-size="30" font-weight="${K.WEIGHT.bold}" fill="${PAPER}">feature</text>
...
const body = `
  ...
  <text x="66" y="548" font-family="${FONT.mono}" font-size="270" font-weight="${K.WEIGHT.bold}" letter-spacing="-12" fill="${TOMATO}">branch</text>
  <text x="1030" y="320" font-family="${FONT.sans}" font-size="180" font-weight="${K.WEIGHT.bold}" letter-spacing="-9" fill="${INK}">不是</text>
  <text x="1030" y="568" font-family="${FONT.sans}" font-size="180" font-weight="${K.WEIGHT.bold}" letter-spacing="-9" fill="${INK}">项目副本</text>

  ${folder}
  <text x="824" y="930" text-anchor="middle" font-family="${FONT.sans}" font-size="170" font-weight="${K.WEIGHT.bold}" fill="${TOMATO}">≠</text>
  ${pointerModel}`;
